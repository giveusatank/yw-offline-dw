...
/**
  ...
  * args(1...n): 指定清洗日期清洗，
  */
object OdsActionLog2DwdActionDoLog {
  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setAppName("JOB-OdsActionLog2DwdActionDoLog").set("spark.sql.shuffle.partitions", Constants.dws_shuffle_partitions)
